...
Your **home directory** (`/cluster/home/your_utln`) is for scripts, notebooks, and small files — it has a fixed quota, so don't fill it with sequencing data. For larger datasets and shared lab work, use your **lab project space** at `/cluster/tufts/your_lab_name/your_utln`.
